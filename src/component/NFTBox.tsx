  ...
  return (
    <Box className={classNamePicker(variant)} p={'1px'} borderRadius="lg" display="inline-block">
      ...
      >
        <Center>
          <NFTImage
            src={(openseaAsset && openseaAsset.image_thumbnail_url) ?
                  ...
                  <HStack justify="space-between">
                    {finalPrice ?
                      <>
                        ...
                        <Text color="inherit" textAlign="right">Buy&nbsp;now</Text>
                      </>:
                      <Text textAlign="center" color="inherit">Not available</Text>
                    }
                  </HStack>
                }
              </Box>
