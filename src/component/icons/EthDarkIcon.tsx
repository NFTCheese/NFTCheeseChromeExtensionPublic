...
function EthDarkIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <path
        ...
        transform="translate(-1240 -305) translate(435.571 533.916) translate(729.844 -228.242) translate(-849.263 .031)"
      ></path>
      <path
        fill="#343434"
        fillRule="nonzero"
